...
$(document).ready(function () {
    ...
    function showOnBoard() {
        $onBoardSection.removeClass('hidden');

        makeStepAction(onBoard.currentStep);
    }

    function hideOnBoard() {
        $onBoardSection.addClass('hidden');
    ...
    function makeStepAction(currentStep) {
        switch (currentStep) {
            ...
            case $steps.MANUAL_ZONES_1_STEP:
                $onBoardSection.find('#dpd-on-board').removeClass('center-top').addClass('right-center');
                markOnBoardElement(
                  '.nav-tabs a[href*="AdminDPDBalticsZones"]',
                  'on-board-border-secondary-color without-bottom'
                );
                break;
            ...
            case $steps.MANUAL_ZONES_6_STEP:
                ...
                markOnBoardElement(
                  '.nav-tabs a[href*="AdminDPDBalticsProducts"]',
                  'on-board-border-secondary-color without-bottom'
                );
                break;
            ...
            case $steps.MANUAL_PRICE_RULES_0_STEP:
                ...
                markOnBoardElement(
                  '.nav-tabs a[href*="AdminDPDBalticsPriceRules"]',
                  'on-board-border-secondary-color without-bottom'
                );
                break;
