...
$(document).ready(function () {
    ...
    function toggleAddressFields() {
        ...
        switch (addressType) {
            case 'company':
                $form.find('#first_name').closest('.form-group').addClass('hidden');
                $form.find('#last_name').closest('.form-group').addClass('hidden');
                $form.find('#company_name').closest('.form-group').removeClass('hidden');

                $form.find('#first_name').val('');
                $form.find('#last_name').val('');
                break;
            case 'individual':
                $form.find('#first_name').closest('.form-group').removeClass('hidden');
                $form.find('#last_name').closest('.form-group').removeClass('hidden');
                $form.find('#company_name').closest('.form-group').addClass('hidden');
