...
$(document).ready(function() {
    ...
    function togglePickupAddressFields()
    {
        ...
        switch (addressType) {
            case 'company':
                $form.find('#pickup_address_first_name').closest('.form-group').addClass('hidden');
                $form.find('#pickup_address_last_name').closest('.form-group').addClass('hidden');
                $form.find('#pickup_address_company_name').closest('.form-group').removeClass('hidden');

                $form.find('#pickup_address_first_name').val('');
                $form.find('#pickup_address_last_name').val('');
                break;
            case 'individual':
                $form.find('#pickup_address_first_name').closest('.form-group').removeClass('hidden');
                $form.find('#pickup_address_last_name').closest('.form-group').removeClass('hidden');
                $form.find('#pickup_address_company_name').closest('.form-group').addClass('hidden');
    ...
    function toggleReceiverAddressFields()
    {
        ...
        switch (addressType) {
            case 'company':
                $form.find('#receiver_address_first_name').closest('.form-group').addClass('hidden');
                $form.find('#receiver_address_last_name').closest('.form-group').addClass('hidden');
                $form.find('#receiver_address_company_name').closest('.form-group').removeClass('hidden');

                $form.find('#receiver_address_first_name').val('');
                $form.find('#receiver_address_last_name').val('');
                break;
            case 'individual':
                $form.find('#receiver_address_first_name').closest('.form-group').removeClass('hidden');
                $form.find('#receiver_address_last_name').closest('.form-group').removeClass('hidden');
                $form.find('#receiver_address_company_name').closest('.form-group').addClass('hidden');
