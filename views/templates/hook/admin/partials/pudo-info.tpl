<div class="col-lg-12 pudo-info-container">
    <input class="hidden" name="selected-pudo-id" value="{$selectedPudo->getParcelShopId()}">
    <input class="hidden" name="selected_pudo_iso_code" value="{$selectedPudo->getCountry()}">
    <div class="well">
