        ...
        <ul class="list-inline">
            {foreach from=$pudoServices item=service}
                <li class="list-group-item list-inline-item"
                    data-listid="{$service->getParcelShopId()|escape:'htmlall':'UTF-8'}">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <p
                                    ...
                                    data-content="{include file='./working-hours.tpl' workingHours=$service->getOpeningHours()}{if isset($service->extraInfo)}{$service->extraInfo}{/if}">
                                {l s='more information' mod='dpdbaltics'}
                            </p>
                            </div>
                            <div class="col-lg-6">
                                <button
                                        class="dpd-action-button btn btn-secondary button
                    ...
                    <div class="extra-info-list">
                        {if !empty($service->getOpeningHours())}
                            ...
                            <div class="extra-info-working-hours dpd-hidden">
                                ...
                                {include file='./working-hours.tpl' workingHours=$service->getOpeningHours()}
