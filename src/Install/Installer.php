...
use Invertus\dpdBaltics\Util\HashUtility;
...
class Installer
{
    ...
    public function getDefaultConfiguration()
    {
        return [
            ...
            Config::DPDBALTICS_HASH_TOKEN => HashUtility::hash('dpdbaltics_token'),
    ...
    private function installTabs()
    {
        ...
        $tabsInitializer = new TabsInitializer(_PS_VERSION_, $tabCollection, $this->module->name);
    ...
    private function uninstallTabs()
    {
        ...
        $tabsService = $this->module->getContainer()->get(TabService::class);

        $tabs = $tabsService->getTabsArray();
