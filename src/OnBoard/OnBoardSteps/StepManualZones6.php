...
class StepManualZones6 extends AbstractOnBoardStep
{
    ...
    public function takeStepData()
    {
        ...
        $templateDataObj->setContainerClass('right-center');
        ...
        if (Configuration::get(Config::WEB_SERVICE_COUNTRY) === Config::LATVIA_ISO_CODE) {
            $templateDataObj->setParagraph(new OnBoardParagraph(
                $this->module->l('You can also choose to import zones automatically. We have prepared standard zones for Latvia. You can import them later in Import/Export tab.', self::FILE_NAME)
            ));
        }
