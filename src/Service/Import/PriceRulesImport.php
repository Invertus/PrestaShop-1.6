        ...
        foreach ($rows as $row) {
            ...
            foreach ($zones as $zone) {
                try {
                    ...
                    $this->warnings[] =
                        $this->module->l(sprintf('Failed to add price rule zone in row: %s', $row[self::POSITION_NAME]));
                }
            }
            ...
            foreach ($shops as $shop) {
                try {
                    ...
                    $this->warnings[] =
                        $this->module->l(sprintf('Failed to add price rule shop in row: %s', $row[self::POSITION_NAME]));
                }
            }
            ...
            foreach ($payments as $payment) {
                try {
                    ...
                    $this->warnings[] =
                        $this->module->l(sprintf('Failed to add price rule payment in row: %s', $row[self::POSITION_NAME]));
                }
            }
            ...
            foreach ($carriers as $carrier) {
                try {
                    ...
                    $this->warnings[] =
                        $this->module->l(sprintf('Failed to add price rule carrier in row: %s', $row[self::POSITION_NAME]));
                }
            }
        }
