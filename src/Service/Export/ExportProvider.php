    ...
    public function returnExportable($exportOption)
    {
        switch ($exportOption) {
            case Config::IMPORT_EXPORT_OPTION_ZONES:
                ...
                $zonesRepo = $this->module->getContainer(ZoneRepository::class);
