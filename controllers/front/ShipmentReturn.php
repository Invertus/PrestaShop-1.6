...
//        return phpinfo();
    ...
    private function printReturnLabel($orderId, $returnTemplateId)
    {
        ...
        $shipmentRepo = $this->module->getContainer(ShipmentRepository::class);
        ...
        $labelApiService = $this->module->getContainer(LabelApiService::class);
        ...
        try {
            ...
            $shipmentService = $this->module->getContainer(ShipmentService::class);
