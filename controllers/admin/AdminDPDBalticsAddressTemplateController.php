...
require_once __DIR__ . '/../../src/Entity/DPDAddressTemplate.php';
...
class AdminDPDBalticsAddressTemplateController extends AbstractAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->initList();
        $this->initForm();
        $this->addressTemplateService = $this->module->getContainer()->get(AddressTemplateService::class);
    ...
    public function initToolbar()
    {
        ...
        if ($this->display !== 'edit' && $this->display !== 'add') {
            $this->toolbar_btn['import'] = [
                'href' => $this->context->link->getAdminLink('AdminDPDBalticsImportExport') . '&importContr='
    ...
    private function getFieldFormVars()
    {
        ...
        $shopRepository = $this->module->getContainer()->get(ShopRepository::class);
        ...
        if (count($shops) > 1) {
            ...
            $searchBoxBuilder = $this->module->getContainer()->get(SearchBoxBuilder::class);
    ...
    private function initForm()
    {
        ...
        if (Tools::getIsset('submitAdddpd_address_template')) {
            ...
            $addressRepo = $this->module->getContainer(AddressRepository::class);
