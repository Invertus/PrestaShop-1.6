...
require_once __DIR__ . '/../../src/Entity/DPDCollectionRequest.php';
...
class AdminDPDBalticsCollectionRequestController extends AbstractAdminController
{
    ...
    private function initForm()
    {
        ...
        if (Tools::getIsset('submitAdddpd_collection_request')) {
            ...
            $collectionRequestRepository = $this->module->getContainer(CollectionRequestRepository::class);
    ...
    public function postProcess()
    {
        if (Tools::isSubmit('submitAdddpd_collection_request')) {
            ...
            $collectionRequestService = $this->module->getContainer(CollectionRequestService::class);
            try {
