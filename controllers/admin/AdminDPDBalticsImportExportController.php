...
class AdminDPDBalticsImportExportController extends AbstractAdminController
{
    ...
    protected function initOptions()
    {
        ...
        $importExportProvider = $this->module->getContainer()->get(ImportExportOptionsProvider::class);
        /** @var InfoBlockRender $infoBlockRender */
        $infoBlockRender = $this->module->getContainer()->get(InfoBlockRender::class);
        ...
        $importParcelsInfoBlockText =
            $this->l('You can import or update list of pick-up points by clicking Import button. We would recommend to update pick-up points at least once a day, as DPD Pick-up network is expanding regularly');
    ...
    private function getWarningBlockTemplate($warningBlockText)
    {
        ...
        $warningBlockTemplate = $this->module->getContainer()->get(WarningBlockBuilder::class);
    ...
    private function postProcessExport()
    {
        ...
        $exportProvider = $this->module->getContainer(ExportProvider::class);
    ...
    private function postProcessImport($importOption, $deleteOnImport, $importFile = null, $useTransaction = true)
    {
        ...
        if ($importOption == Config::IMPORT_EXPORT_OPTION_ALL_ZIP) {
            ...
            $zipImport = $this->module->getContainer(ZipImport::class);
            ...
            if (Configuration::get(Config::ON_BOARD_TURNED_ON) &&
                ...
                $flashMessageService = $this->module->getContainer(DPDFlashMessageService::class);
        ...
        try {
            ...
            $importProvider = $this->module->getContainer(ImportProvider::class);
            if ($deleteOnImport) {
        ...
        try {
            switch ($importOption) {
                case Config::IMPORT_EXPORT_OPTION_ZONES:
                    /** @var ZoneImport */
                    return $this->module->getContainer(ZoneImport::class);
                    break;
                case Config::IMPORT_EXPORT_OPTION_SETTINGS:
                    /** @var ZoneImport */
                    return $this->module->getContainer(SettingsImport::class);
                    break;
                case Config::IMPORT_EXPORT_OPTION_PRICE_RULES:
                    /** @var PriceRulesImport */
                    return $this->module->getContainer(PriceRulesImport::class);
                    break;
                case Config::IMPORT_EXPORT_OPTION_ADDRESS_TEMPLATES:
                    /** @var AddressTemplatesImport */
                    return $this->module->getContainer(AddressTemplatesImport::class);
                    break;
                case Config::IMPORT_EXPORT_OPTION_PRODUCTS:
                    /** @var ProductImport */
                    return $this->module->getContainer(ProductImport::class);
                    break;
                default:
