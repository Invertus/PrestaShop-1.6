...
require_once __DIR__ . '/../../src/Entity/DPDZone.php';
...
class AdminDPDBalticsZonesController extends AbstractAdminController
{
    ...
    public function setMedia($isNewTheme = false)
    {
        ...
        $zoneRangeProvider = $this->module->getContainer()->get(ZoneRangeProvider::class);
    ...
    public function postProcess()
    {
        ...
        $updateZoneService = $this->module->getContainer()->get(UpdateZoneService::class);
        $zoneAdapter = $this->module->getContainer()->get(ZoneAdapter::class);
        $zoneRangeValidate = $this->module->getContainer()->get(ZoneRangeValidate::class);
    ...
    public function processDelete()
    {
        ...
        $deleteZoneService = $this->module->getContainer()->get(DeleteZoneService::class);
    ...
    private function updateOnBoardAndAddTemplateToResponseOnZoneSave($response)
    {
        if (Configuration::get(Config::ON_BOARD_TURNED_ON) &&
            ...
            $onBoardStepActionService = $this->module->getContainer(OnBoardStepActionService::class);
            ...
            if(Tools::getValue('buttonName') === Config::ZONES_SAVE_AND_STAY_BUTTON) {
                ...
                $onBoardService = $this->module->getContainer(OnBoardService::class);
