...
require_once __DIR__ . '/../../src/Entity/DPDPriceRule.php';
...
class AdminDPDBalticsPriceRulesController extends AbstractAdminController
{
    ...
    public function __construct()
    {
        ...
        $this->initList();
        $this->initForm();
        $this->priceRuleService = $this->module->getContainer()->get(PriceRuleService::class);
    }
    ...
    public function postProcess()
    {
        if (Tools::getIsset('duplicatePriceRule')) {
            ...
            if (!$this->priceRuleService->duplicatePriceRule($idPriceRule)) {
                ...
                $flashMessageService = $this->module->getContainer()->get(DPDFlashMessageService::class);
        ...
        if ($this->display !== 'edit' && $this->display !== 'add') {
            $this->toolbar_btn['import'] = [
                'href' => $this->context->link->getAdminLink(
                    'AdminDPDBalticsImportExport' . 'importContr=' . Config::IMPORT_EXPORT_OPTION_PRICE_RULES
                ),
                'desc' => $this->l('Import'),
            ];
        }
    ...
    private function getFieldFormVars()
    {
        ...
        $zoneRepository = $this->module->getContainer()->get(DPDZoneRepository::class);
