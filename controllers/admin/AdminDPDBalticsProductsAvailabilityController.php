...
class AdminDPDBalticsProductsAvailabilityController extends AbstractAdminController
{
    ...
    public function setMedia($isNewTheme = false)
    {
        ...
        $productAvailabilityProvider = $this->module->getContainer(ProductAvailabilityProvider::class);
    ...
    public function postProcess()
    {
        ...
        $productAvailabilityService = $this->module->getContainer(ProductAvailabilityService::class);
