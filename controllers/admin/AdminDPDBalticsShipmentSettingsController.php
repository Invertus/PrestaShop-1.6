...
class AdminDPDBalticsShipmentSettingsController extends AbstractAdminController
{
    ...
    public function postProcess()
    {
        ...
        $codPaymentRepo = $this->module->getContainer(CodPaymentRepository::class);
    ...
    protected function initOptions()
    {
        ...
        $addressTemplateRepo = $this->module->getContainer(AddressTemplateRepository::class);
        ...
        $labelPositionService = $this->module->getContainer(LabelPositionService::class);
